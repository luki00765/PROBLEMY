...
int main(int argc, char **argv){
	...
	MPI_Scatter(vectorX, podzial, MPI_INT, subvectorX, podzial, MPI_INT, 0, 		MPI_COMM_WORLD);
	MPI_Scatter(vectorY, podzial, MPI_INT, subvectorY, podzial, MPI_INT, 0, 		MPI_COMM_WORLD);
